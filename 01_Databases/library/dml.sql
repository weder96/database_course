/* ================================================
SCRIPT DE CRIAÇÃO E CARGA (VERSÃO ESTENDIDA 5X)
================================================
*/
-- 1. Criação do Banco
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'DB_Revisao_SciFi')
BEGIN
    CREATE DATABASE DB_Revisao_SciFi;
END
GO

USE DB_Revisao_SciFi;
GO
...
-- 3. Criação das Tabelas (Estrutura idêntica)
